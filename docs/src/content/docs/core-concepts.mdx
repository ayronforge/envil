---
title: Core Concepts
description: Understand how envil validates variables, separates client/server access, and uses a proxy for runtime safety.
order: 3
---
...
This is what [framework presets](/envil/docs/framework-presets) configure for you.
...
```ts
import { createEnv, requiredString, postgresUrl, port, withDefault } from "@ayronforge/envil"
